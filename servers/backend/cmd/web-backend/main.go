...
func main() {
	...
	physicalQuantityWithEvaluate := repository.NewPhysicalQuantityWithEvaluateRepository(mysql)
	...
	physicalQuantityController := controller.NewPhysicalQuantityController(jsonResponse, physicalQuantityUsecase, physicalQuantityWithEvaluateUsecase)
